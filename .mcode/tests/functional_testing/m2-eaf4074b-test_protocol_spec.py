...
Generated at: 2026-03-02T00:03:34.945322+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/",
        "method": "GET",
        "description": "Verify the products service health check endpoint returns ok status",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/productos/",
        "method": "POST",
        "description": "Create a valid product and verify the response contains the product with an assigned ID",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "create_product_missing_required_field",
        "category": "MISSING_REQUIRED",
        "endpoint": "/productos/",
        "method": "POST",
        "description": "Attempt to create a product without the required 'nombre' field, expect validation error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/productos/",
        "method": "POST",
        "description": "Attempt to create a product with a negative price, expect validation error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/productos/",
        "method": "POST",
        "description": "Attempt to create a product with negative stock, expect validation error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "nombre": "Invalid Stock Product",
                "precio": 25.0,
                "stock": -3
            }
        },
    ...
    },
    {
        ...
        "endpoint": "/productos/",
        "method": "GET",
        "description": "List all products, expect a 200 response with an array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "PATCH",
        "description": "Create a product, update its stock to a valid value, then verify the updated stock",
        "setup": {
            "endpoint": "/productos/",
            "method": "POST",
            "body": {
                "nombre": "Stock Test Product",
                "precio": 49.99,
                "stock": 100
            },
            "extract_id_from": "id"
    ...
    {
        "name": "update_stock_negative_value",
        "category": "INVALID_INPUT",
        "endpoint": "/productos/{product_id}/stock/{stock}",
        "method": "PATCH",
        "description": "Attempt to set stock to a negative value, expect 400 error",
        "setup": {
            "endpoint": "/productos/",
            "method": "POST",
            "body": {
                "nombre": "Negative Stock Test",
                "precio": 30.0,
                "stock": 10
            },
            "extract_id_from": "id"
    ...
    },
    {
        ...
        "endpoint": "/productos/{product_id}/stock/{stock}",
        "method": "PATCH",
        "description": "Attempt to update stock for a non-existent product ID, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "product_id": 999999,
    ...
    {
        "name": "update_stock_to_zero",
        "category": "BOUNDARY",
        "endpoint": "/productos/{product_id}/stock/{stock}",
        "method": "PATCH",
        "description": "Set stock to zero (boundary value), expect success",
        "setup": {
            "endpoint": "/productos/",
            "method": "POST",
            "body": {
                "nombre": "Zero Stock Test",
                "precio": 15.0,
                "stock": 20
            },
            "extract_id_from": "id"
