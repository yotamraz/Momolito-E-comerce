...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/",
        "method": "GET",
        "description": "Verify the health-check root endpoint returns service status",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "request_data": {
            ...
            "body": {
                "nombre": "Carlos Lopez",
                "email": "carlos.lopez.happy@example.com"
            }
        },
        "expected_status": 200,
        "cleanup": null
    },
    {
        ...
        "endpoint": "/usuarios/",
        "method": "POST",
        "description": "Attempt to create a user with an already registered email, expect 400",
        "setup": {
            "endpoint": "/usuarios/",
            "method": "POST",
            "body": {
                "nombre": "Maria Garcia",
                "email": "maria.dup.test@example.com"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/usuarios/",
        "method": "POST",
        "description": "Attempt to create a user without the required nombre field, expect 422",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "create_user_empty_nombre",
        "category": "BOUNDARY",
        "endpoint": "/usuarios/",
        "method": "POST",
        "description": "Attempt to create a user with an empty nombre (violates min_length=1), expect 422",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/usuarios/",
        "method": "GET",
        "description": "Retrieve the list of all users, expect 200 with an array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "setup": {
            ...
            "body": {
                "nombre": "Ana Perez",
                "email": "ana.perez.gettest@example.com"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/usuarios/{user_id}",
        "method": "GET",
        "description": "Attempt to retrieve a user with a non-integer ID, expect 422",
        "setup": null,
        "request_data": {
            "path": {
